...
@admin.register(models.HomeEventosSeccion)
class HomeEventosSeccionAdmin(SingleModelAdmin, TranslationAdmin):
	model = models.HomeEventosSeccion
	list_display = ['__unicode__']
	fieldsets = (
		('Banner', {'fields': ('cabecera',)}),
		('Bloque', {'fields': ('b_titulo','b_descript')})
	)
	# ordering = ['posicion']

@admin.register(models.EventosSociales)
class EventosSocialesAdmin(TranslationAdmin):
	model = models.EventosSociales
...
@admin.register(models.HomeNoticiasSeccion)
class HomeNoticiasSeccionAdmin(SingleModelAdmin, TranslationAdmin):
	model = models.HomeNoticiasSeccion
	list_display = ['__unicode__']
	fieldsets = (
		('Banner', {'fields': ('cabecera',)}),
		('Bloque', {'fields': ('b_titulo','b_descript')})
